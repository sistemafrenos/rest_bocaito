            ...
            unsafe
            {
              ...
              //     bRet = SendCmd(&status, &error, "810  ==========");
                   ...
                   // CargarS2();
                    ...
                    //var montoBsS = String.Format(CultureInfo.CreateSpecificCulture("es-VE"), "{0:0,0.00}", documento.MontoTotal / 1000);
                    //bRet = SendCmd(&status, &error, "@" + "Sum Tot. expresado en BsS:" + montoBsS);
